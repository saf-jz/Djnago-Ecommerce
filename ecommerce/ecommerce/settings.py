...
SECRET_KEY = 'django-insecure-&*k+gzqki6gf-6d7-_el@)3pxsj@4mt6g6a*#dcx=+@ffal_sn'
...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = 'sj50025010@gmail.com'  # Your email address
EMAIL_HOST_PASSWORD = 'msvd ouqh bxgq euej'  # Your email password (use app)